...
class _ProductSearchScreenState extends State<ProductSearchScreen> {
  ...
  Future<void> fetchProductImage(String query) async {
    ...
    String apiUrl = 'https://api.unsplash.com/search/photos?query=$query&client_id=2LfkFkoXAU_wNQse8mc0BsVKN3eZhKom8v0IWbZCq7k';  // Replace YOUR_ACCESS_KEY with your actual API key
